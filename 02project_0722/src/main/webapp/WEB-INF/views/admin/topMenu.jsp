    ...
    <div class="container mx-auto px-6 py-3 flex justify-between items-center">
        ...
        <div class="hidden md:flex md:space-x-8 justify-center w-full">
            ...
            <div x-data="{ open: false }" class="relative">
                ...
                <div x-show="open" @click.away="open = false" class="absolute left-0 mt-2 w-48 bg-white shadow-lg rounded-lg py-2">
                    <a href="${pageContext.request.contextPath}/comment/list.do" class="block px-4 py-2 text-gray-600 hover:bg-gray-100">댓글 목록</a>
                    <a href="#" class="block px-4 py-2 text-gray-600 hover:bg-gray-100">댓글 추가</a>
                </div>
            </div>
            <div x-data="{ open: false }" class="relative">
