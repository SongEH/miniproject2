	      ...
	      // 선택한 날짜에 대한 데이터 조회 
	       ...
	       $.ajax({
                 ...
                 success: function(response) {
                     ...
                     $('#diary_select_date').html(`
                         <form id="memoForm" action="diaryAdd.do" method="post">
                           <input type="hidden" name="selected_date" value="${info.dateStr}">
                           
                           <label for="petName">Pet Name:</label>
                          /*  <input type="text" id="petName" name="petName" value="${data.petName}"><br> */
                           <input type="text" id="petName" name="petName" value="되나요"><br>
