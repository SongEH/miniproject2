...
<script type="text/javascript" src="<%=ctx %>/resources/smarteditor2/js/HuskyEZCreator.js" charset="utf-8"></script>
...
<table width="100%">
        <tr>
            <td>제목</td>
            <td><input type="text" id="title" name="b_title" style="width:650px"/></td>
        </tr>
        <tr>
            <td>내용</td>
            <td>
                <textarea rows="10" cols="30" id="ir1" name="b_content" style="width:650px; height:350px; "></textarea>
            </td>
        </tr>
         <tr>
            <td>카테고리</td>
            <td>
            	<select id="" name="b_cate">
