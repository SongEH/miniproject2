			...
			<div class="col-sm-4">
				<div class="card equal-card">
					<div class="card-body">
						...
						<h2 class="card-title">${item.b_title}</h2>
						...
						<div class="reply-content equal-reply-content"
							...
							<p class="card-text">
								<strong>Reply:</strong>
								<textarea name="a_content">안녕하십니까!!</textarea>
							</p>
						</div>
					</div>
				</div>
...
<hr>
        ...
        <div class="thumbnail_area">
            <a href="${image_file}" class="thumbnail_inner" target="_blank">
                <img src="${image_file[0]}" alt="포스트 썸네일" width="167" height="167" class="img_post">
            </a>
            <c:if test="${fn:length(image_file) > 1}">
                <a href="#" class="button_more_img" role="button" aria-selected="false" onclick="toggleThumbnails(); return false;">
                    <i class="sp_common icon_more"><span class="blind">글 썸네일 펼치기</span></i>
                </a>
                <div id="plusThumbnailList" class="plus_thumbnail_list" style="display: none;">
                    <a href="${image_file}" target="_blank" class="list_inner" title="포스트로 이동">
                        <c:forEach items="${image_file}" var="thumbnail" begin="1">
                            <div class="plus_item">
                                <img src="${image_file}" alt="글 섬네일" width="167" height="167" class="plus_img">
                            </div>
                        </c:forEach>
                    </a>
                </div>
