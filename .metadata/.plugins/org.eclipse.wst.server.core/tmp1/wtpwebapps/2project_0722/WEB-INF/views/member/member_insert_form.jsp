					...
					<table class="table">
						...
						<tr>
							...
							<td><input type="text" id="email_id" class="form-control"
								value="" title="이메일 아이디" maxlength="18" /> @ <input type="text"
								id="email_domain" class="form-control" value="" title="이메일 도메인"
								maxlength="18" /> <select class="select, form-control"
								title="이메일 도메인 주소 선택"
						...
						<tr>
							...
							<td><input class="form-control" name="m_zipcode"
								id="m_zipcode"> <input class="btn  btn-info"
						...
						<tr>
							<td colspan="2" align="center"><input
								class="btn btn-success" type="button" value="메인화면"
								onclick="location.href='../main.do'"> <input
								id="btn_register" class="btn btn-primary" type="button"
